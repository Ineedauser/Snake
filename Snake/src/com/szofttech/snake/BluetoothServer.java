...
public class BluetoothServer {
	...
	private class AcceptThread extends Thread {
    	volatile BluetoothServerSocket serverSocket = null;
        ...
        public void run() {
            ...
            int [] failedCount = new int [MAX_CONNECTIONS];
            for (int a=0; a<failedCount.length; a++)
            	failedCount[a]=0;
            ...
            while (running){
            	...
            	for (int i = 0; i < MAX_CONNECTIONS; i++) {
            		...
            		try {
            			...
            			failedCount[i]++;
            			if (failedCount[i]>MAX_FAIL_COUNT){
            				stopMe();
            				return;
            			}
